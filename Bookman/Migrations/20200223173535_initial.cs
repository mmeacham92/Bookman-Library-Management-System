...
namespace Bookman.Migrations
{
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Conditions",
                columns: new[] { "ConditionID", "Status" },
                values: new object[,]
                {
                    { 1, "New" },
                    { 2, "Like New" },
            ...
            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "BookID", "AuthorFirstName", "AuthorLastName", "BindingID", "ConditionID", "GenreID", "ImageString", "PageCount", "Title" },
                values: new object[] { 1, "Patrick", "Rothfuss", 2, 2, 3, "the-name-of-the-wind.jpg", 662, "The Name of the Wind" });
